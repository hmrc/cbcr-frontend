...
object CBCErrors {
  implicit val show: Show[CBCErrors] = Show.show[CBCErrors] {
    ...
    case InvalidSession               => InvalidSession.productPrefix
    case ExpiredSession(msg)          => msg
    case error: CBCErrors             => error.productPrefix
  }
}
...
object BusinessRuleErrors {
  implicit val format: Format[BusinessRuleErrors] = new Format[BusinessRuleErrors] {
    override def writes(o: BusinessRuleErrors): JsValue = o match {
      ...
      case ReceivingCountryError                    => JsString(ReceivingCountryError.productPrefix)
      case fne: FileNameError                       => Json.toJson(fne)
      case MessageTypeIndicError                    => JsString(MessageTypeIndicError.productPrefix)
      case m: InvalidXMLError                       => JsString(m.toString)
      case InvalidDocRefId                          => JsString(InvalidDocRefId.productPrefix)
      case InvalidCorrDocRefId                      => JsString(InvalidCorrDocRefId.productPrefix)
      case CorrDocRefIdInvalidRecord                => JsString(CorrDocRefIdInvalidRecord.productPrefix)
      case CorrDocRefIdUnknownRecord                => JsString(CorrDocRefIdUnknownRecord.productPrefix)
      case DocRefIdDuplicate                        => JsString(DocRefIdDuplicate.productPrefix)
      case DocRefIdInvalidParentGroupElement        => JsString(DocRefIdInvalidParentGroupElement.productPrefix)
      case CorrDocRefIdInvalidParentGroupElement    => JsString(CorrDocRefIdInvalidParentGroupElement.productPrefix)
      case CorrDocRefIdMissing                      => JsString(CorrDocRefIdMissing.productPrefix)
      case CorrDocRefIdNotNeeded                    => JsString(CorrDocRefIdNotNeeded.productPrefix)
      case CorrDocRefIdDuplicate                    => JsString(CorrDocRefIdDuplicate.productPrefix)
      case IncompatibleOECDTypes                    => JsString(IncompatibleOECDTypes.productPrefix)
      case MessageTypeIndicDocTypeIncompatible      => JsString(MessageTypeIndicDocTypeIncompatible.productPrefix)
      case CbcOecdVersionError                      => JsString(CbcOecdVersionError.productPrefix)
      case XmlEncodingError                         => JsString(XmlEncodingError.productPrefix)
      case OriginalSubmissionNotFound               => JsString(OriginalSubmissionNotFound.productPrefix)
      case PrivateBetaCBCIdError                    => JsString(PrivateBetaCBCIdError.productPrefix)
      case ResentDataIsUnknownError                 => JsString(ResentDataIsUnknownError.productPrefix)
      case MultipleCbcBodies                        => JsString(MultipleCbcBodies.productPrefix)
      case NoCbcReports                             => JsString(NoCbcReports.productPrefix)
      case CorrectedFileTooOld                      => JsString(CorrectedFileTooOld.productPrefix)
      case CorrectedFileDateMissing                 => JsString(CorrectedFileDateMissing.productPrefix)
      case ReportingEntityOrConstituentEntityEmpty  => JsString(ReportingEntityOrConstituentEntityEmpty.productPrefix)
      case CorrMessageRefIdNotAllowedInMessageSpec  => JsString(CorrMessageRefIdNotAllowedInMessageSpec.productPrefix)
      case CorrMessageRefIdNotAllowedInDocSpec      => JsString(CorrMessageRefIdNotAllowedInDocSpec.productPrefix)
      case ReportingPeriodInvalid                   => JsString(ReportingPeriodInvalid.productPrefix)
      case MultipleFileUploadForSameReportingPeriod => JsString(MultipleFileUploadForSameReportingPeriod.productPrefix)
      case MessageRefIdDontMatchWithDocRefId        => JsString(MessageRefIdDontMatchWithDocRefId.productPrefix)
      case InconsistentCurrencyCodes                => JsString(InconsistentCurrencyCodes.productPrefix)
      case PartiallyCorrectedCurrency               => JsString(PartiallyCorrectedCurrency.productPrefix)
      case PartialDeletion                          => JsString(PartialDeletion.productPrefix)
      case aidnf: AdditionalInfoDRINotFound         => Json.toJson(aidnf)
      case DocRefIdMismatch                         => JsString(DocRefIdMismatch.productPrefix)
      case ReportingEntityElementMissing            => JsString(ReportingEntityElementMissing.productPrefix)
      case ResendOutsideRepEntError                 => JsString(ResendOutsideRepEntError.productPrefix)
      case ResendDocRefIdInvalid                    => JsString(ResendDocRefIdInvalid.productPrefix)
      case MessageTypeIndicBlank                    => JsString(MessageTypeIndicBlank.productPrefix)
      case MessageTypeIndicInvalid                  => JsString(MessageTypeIndicInvalid.productPrefix)
      case AddressCityEmpty                         => JsString(AddressCityEmpty.productPrefix)
      case OtherInfoEmpty                           => JsString(OtherInfoEmpty.productPrefix)
      case DatesOverlapInvalid                      => JsString(DatesOverlapInvalid.productPrefix)
      case StartDateNotBefore01012016               => JsString(StartDateNotBefore01012016.productPrefix)
      case StartDateAfterEndDate                    => JsString(StartDateAfterEndDate.productPrefix)
      case EndDateSameAsReportingPeriod             => JsString(EndDateSameAsReportingPeriod.productPrefix)
      case AllReportingdatesInFuture                => JsString(AllReportingdatesInFuture.productPrefix)
    }
...
object MessageRefIDError {
  implicit val format: Format[MessageRefIDError] = new Format[MessageRefIDError] {
    override def writes(o: MessageRefIDError): JsValue = JsString(o.productPrefix)
