...
case class MessageSpec(messageRefID: MessageRefID, receivingCountry:String, sendingEntityIn:CBCId, timestamp:LocalDateTime, reportingPeriod:Year,messageType:MessageTypeIndic)
object MessageSpec{
