...
import uk.gov.hmrc.cbcrfrontend.model.{AffinityGroup, Agent, Individual, Organisation}

import scala.concurrent.Future

class AffinityGroupPredicateSpec extends TestPredicate {
  override def configFile: String = ""
