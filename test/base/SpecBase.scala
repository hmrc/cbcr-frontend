...
trait SpecBase
  ...
  val cbcId: CBCId = CBCId("XLCBC0100000056").getOrElse(fail("booo"))
  val enrolment: CBCEnrolment = CBCEnrolment(cbcId, Utr("1234567890"))
  val uploadId: UploadId = UploadId("123")
  val creds: Credentials = Credentials("totally", "legit")
  val cacheMap: CacheMap = CacheMap("x", Map("x" -> Json.toJson[String]("x")))
