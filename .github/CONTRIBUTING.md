# Contributing Guidelines for cbcr-frontend
...
Once you've identified (or created) an [issue](https://github.com/hmrc/cbcr-frontend/issues) to work on, please follow these guidelines to contribute code:
