...
contactDetailsUpdate.email=We''ll send you a confirmation email to the updated address.
...
start.button=Start
start.required=Select an option
...
subscribeSuccessCbcId.next2=Continue if the report is ready to check and send, or
subscribeSuccessCbcId.nextLink=exit
...
fileUploadResult.error.data.message=Ask the person who created the XML file to correct the errors
...
enterCompanyName.form.error.header=You haven''t entered the agent organisation name.
...
uploadReport.moreInfo=Os yw''r adroddiad yn barod i''w anfon, gallwch ddewis ei anfon yn awr neu''n hwyrach.
uploadReport.inputField.label=Dewiswch y ffeil yr ydych am ei wirio:
uploadReport.uploadButton=Gwiriwch yr adroddiad
uploadReport.error=Gwiriwch yr adroddiad Rhaid i chi ddewis ffeil
...
submitterInfo.fullName.error=Enter the full name
...
submitterInfo.phoneNumber.error.empty=Enter the phone number
...
submitterInfo.emailAddress.error.empty=Enter the email address
...
sessionTimeout.title=You'’re about to be signed out
...
error.FileNameError=The filename and messageRefID should match. You entered this filename: It should read:
...
error.MessageTypeIndicDocTypeIncompatible=Error DocTypeIndic (New): If MessageTypeIndic is provided and completed with "CBC401" DocTypeIndic must be "OECD1"
...
error.CbcOecdVersionError=Rhaid i fersiwn CBC_OECD fod yn gyfartal 1.0.1
error.XmlEncodingError=XML encoding must equal UTF8
...
error.ResentDataIsUnknownError=OECD0 must be used for resent data, but a previous submission with this DocRefID has not been received
...
xmlError.InvalidDocType=Annilys DocTypeIndic
xmlError.ReportingRole=ReportingEntity.ReportingRole heb eu darganfod neu annilys
xmlError.InvalidDate=Dyddiad Annilys ar gyfer y cyfnod adrodd
xmlError.TINIssuedBy=The TIN.issuedBy attribute must be ''GB'' for Primary and Local Filing
xmlError.InvalidTIN=Rhaid i'r elfen TIN fod yn ddilys UK UTR